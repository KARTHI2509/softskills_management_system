...
Purpose: Renders high-fidelity AI Group Discussion Coach layouts.
Responsibilities: Models AI coach evaluations, argument feedback, stance toggles, custom topic inputs, and rosters.
...
import { 
  ...
  Brain, Target, Info, RefreshCw, X, Play
} from 'lucide-react';
...
const GroupDiscussion = () => {
  ...
  const handleEvaluateStance = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        // Safe fallback matching standard backend formats
        setEvaluation({
          score: 84,
      ...
      console.error(err);
      // Friendly simulation auto-fallback
      setEvaluation({
        score: 82,
  ...
  const handleStanceChange = (newStance) => {
    setStance(newStance);
    // Clear previous evaluation to avoid mismatch of outdated stance evaluations
    setEvaluation(null);
  };
    ...
    <div className="space-y-8 relative">
          ...
          <div className="bg-white dark:bg-[#111625] border border-slate-200 dark:border-slate-800 rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-6 relative">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start gap-4 p-3 bg-blue-500/5 border border-blue-500/10 rounded-2xl">
                <div>
                  <h4 className="font-extrabold text-xs text-blue-505">Logic Consistency (40%)</h4>
              ...
              <div className="flex justify-between items-start gap-4 p-3 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
                <div>
                  <h4 className="font-extrabold text-xs text-emerald-505">Defense &amp; Anticipation (30%)</h4>
                  <p className="text-[10px] text-slate-455 font-semibold mt-1 leading-relaxed">
              ...
              <div className="flex justify-between items-start gap-4 p-3 bg-purple-500/5 border border-purple-500/10 rounded-2xl">
                <div>
                  <h4 className="font-extrabold text-xs text-purple-505">Relevance &amp; Clarity (30%)</h4>
                  <p className="text-[10px] text-slate-455 font-semibold mt-1 leading-relaxed">
      ...
      <div>
        <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white flex items-center gap-2">
          <span>AI Group Discussion Coach</span>
          <span className="text-blue-500 font-normal">✨</span>
        </h1>
        <p className="text-slate-505 dark:text-slate-400 mt-1">
          Simulate critical debates. Paste your arguments for a topic, choose a stance, and get detailed AI feedback.
        </p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-6 bg-white dark:bg-[#111625] border border-slate-200 dark:border-slate-800/80 rounded-3xl shadow-md space-y-6">
            ...
            <div className="p-5 bg-slate-50 dark:bg-slate-900/40 border border-slate-150 dark:border-slate-800/60 rounded-2xl flex justify-between items-start gap-4">
              <div>
                <p className="text-[10px] font-black text-slate-450 dark:text-slate-400 uppercase tracking-widest leading-none">Debating Topic</p>
                <h4 className="font-extrabold text-base text-slate-800 dark:text-slate-200 mt-2.5">
                  "{topic}"
                </h4>
              </div>
              <button 
            ...
            <div className="space-y-3.5">
              <div className="flex items-center gap-1.5">
                <span className="text-[10px] font-black text-slate-450 uppercase tracking-widest leading-none">Your Debating Stance</span>
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className={`flex-1 py-3.5 rounded-2xl font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 border transition-all ${
                    stance === 'AGAINST'
                      ? 'bg-rose-500/10 border-rose-500 text-rose-600 dark:text-rose-450 shadow-sm shadow-rose-500/5'
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-black text-slate-450 uppercase tracking-widest leading-none">Write Your Argument Pitch</span>
                  <Info className="w-3.5 h-3.5 text-slate-400 cursor-pointer" />
                </div>
          ...
          {/* AI Coach Evaluation result display */}
          {evaluation && (
            <div className="p-6 bg-white dark:bg-[#111625] border border-slate-200 dark:border-slate-800/80 rounded-3xl shadow-md space-y-6 animate-fadeIn">
              ...
              <div className="grid sm:grid-cols-2 gap-6 pt-2">
                ...
                <div className="p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl space-y-3">
                  <h4 className="font-black text-xs text-emerald-650 dark:text-emerald-450 flex items-center gap-1.5 uppercase tracking-wide">
